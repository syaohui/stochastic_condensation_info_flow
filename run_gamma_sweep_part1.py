"""
run_gamma_sweep_part1.py — Sweep γ from 0.1 to 5.0 (Fig. 2 of the paper, part 1).
...
Usage
-----
    python run_gamma_sweep_part1.py
    python run_gamma_sweep_part1.py --outdir data/sweeps
    python run_gamma_sweep_part1.py --workers 90

Output
------
    gamma_sweep_RD_part1.npz  —  gamma_values, and for each γ (tag e.g. "g0p10"):
...
GAMMA_MIN, GAMMA_MAX, GAMMA_STEP = 0.1, 5.0, 0.1
PART_TAG = "part1"
