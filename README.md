...
|------|-------------|-------------|
| `fig1.png` | Fig. 1 | Mean/std/ε/β vs time (γ = 0.1 s⁻¹)(γ = 10.0 s⁻¹) |
...
## Data Availability
The summary data required to reproduce all figures is archived on Zenodo at https://doi.org/10.5281/zenodo.20790155 (v1.1).
