...
gamma_default  = 0.1         # Correlation rate  [s^{-1}]

# Multiple seeds for robust ensemble averaging
# (replaces the former single RANDOM_SEED = 21)
SEEDS = [2, 5, 8, 17, 21]

# Time-step settings — dt is halved; total simulation time (15 τ) is unchanged
# so the step count doubles.  All simulation scripts import these two constants.
DT_FACTOR = 5.0e-6   # dt = DT_FACTOR × τ        (was 5e-4)
N_STEPS   = 3_000_000   # steps per realization      (was 30 000)
